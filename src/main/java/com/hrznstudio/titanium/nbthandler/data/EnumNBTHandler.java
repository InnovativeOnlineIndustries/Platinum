...
public abstract class EnumNBTHandler<E extends Enum<E>> implements INBTHandler<E> {
    ...
    @Override
    public final boolean storeToNBT(@Nonnull CompoundTag compound, @Nonnull String name, @Nonnull E object) {
        compound.putInt(name, getIdFrom(object));
        return true;
    }

    @Override
    public final E readFromNBT(@Nonnull CompoundTag compound, @Nonnull String name, @Nullable E currentValue) {
